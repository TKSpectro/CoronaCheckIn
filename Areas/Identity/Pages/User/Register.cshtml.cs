...
public class RegisterModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (bool.Parse(_configuration["smtp:enabled"]))
    ...
    private Models.User CreateUser()
    {
        ...
        catch
        {
            throw new InvalidOperationException($"Can't create an instance of '{nameof(User)}'. " +
                                                ...
                                                "override the register page in /Areas/Identity/Pages/User/Register.cshtml");
        }
    }
    ...
    public class InputModel
    {
        ...
        [Required]
        [StringLength(maximumLength: 60, ErrorMessage = "The {0} length cannot be smaller than {2} and bigger than {1} characters. ", MinimumLength = 2)]
